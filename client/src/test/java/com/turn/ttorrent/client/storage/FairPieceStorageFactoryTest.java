...
public class FairPieceStorageFactoryTest {
    ...
    public void testCreatingStorageForLargeFile() throws Exception {
        ...
        when(metadata.getFiles())
                .thenReturn(
                        Collections.singletonList(
                                new TorrentFile(
                                        Collections.singletonList("test.avi"), totalSize, "")));
        ...
        TorrentByteStorage storage =
                new TorrentByteStorage() {
                    @Override
        ...
        PieceStorage pieceStorage =
                FairPieceStorageFactory.INSTANCE.createStorage(metadata, storage);
