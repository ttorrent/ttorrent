...
public interface TorrentListener {
    ...
    /**
     * Invoked when download was failed with any exception (e.g. some runtime exception or i/o
     * exception in file operation).
     *
    ...
    /**
     * Invoked when validation of torrent is done. If total pieces count and valid pieces count are
     * equals it means that torrent is fully downloaded. {@link #downloadComplete()} listener will
