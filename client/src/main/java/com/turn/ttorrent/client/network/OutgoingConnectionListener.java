...
public class OutgoingConnectionListener implements ConnectionListener {
    ...
    public OutgoingConnectionListener(
            Context context, TorrentHash torrentHash, String remotePeerIp, int remotePeerPort) {
    ...
    public void onConnectionEstablished(SocketChannel socketChannel) throws IOException {
        HandshakeSender handshakeSender =
                new HandshakeSender(torrentHash, myRemotePeerIp, myRemotePeerPort, myContext);
