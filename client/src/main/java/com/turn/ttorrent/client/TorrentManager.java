...
public interface TorrentManager extends TorrentHash {
    ...
    /**
     * remove specified listener which was added earlier by {@link TorrentManager#addListener}
     * method. You can receive events in this listener after execution of the method if notify
     * method was invoked before this method
     *
     * @param listener specified listener
     ...
     */
    void awaitDownloadComplete(int timeout, TimeUnit timeUnit)
