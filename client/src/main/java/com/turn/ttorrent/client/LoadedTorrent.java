...
public interface LoadedTorrent {
     ...
     * @throws IllegalStateException if unable to fetch metadata from source (e.g. source is
     *     .torrent file and it was deleted manually)
     */
    TorrentMetadata getMetadata() throws IllegalStateException;

    /**
     * @return new instance of {@link AnnounceableInformation} for announce this torrent to the
     *     tracker
     */
    @NotNull
