...
/**
 * @author Pavel.Sher Date: 05.03.2008
 */
public class TempFiles {
    ...
    /**
     * Returns a File object for created temp directory. Also stores the value into this object
     * accessed with {@link #getCurrentTempDir()}
     *
    ...
    /**
     * Returns the current directory used by the test or null if no test is running or no directory
     * is created yet.
     *
     * @return see above
     */
