...
/**
 * @author Sergey.Pak Date: 8/12/13 Time: 8:25 PM
 */
public class TrackerServiceContainer implements Container {
    ...
    public TrackerServiceContainer(
     ...
     * <p>
     *
     * <p>This makes sure the request is made to the tracker's announce URL, and delegates handling
     * of the request to the <em>process()</em> method after preparing the response object.
     *
