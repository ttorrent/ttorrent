...
public class MultiAnnounceRequestProcessor {
    ...
    public void process(
            ...
            final TrackerRequestProcessor.RequestHandler requestHandler)
            throws IOException {
            ...
            myTrackerRequestProcessor.process(
                    ...
                    new TrackerRequestProcessor.RequestHandler() {
                        ...
                        public void serveResponse(
                                int code, String description, ByteBuffer responseData) {
        ...
        requestHandler.serveResponse(
                isAnySuccess.get() ? Status.OK.getCode() : Status.BAD_REQUEST.getCode(),
                "",
