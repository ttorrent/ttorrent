...
public class TorrentsRepositoryTest {
    ...
    public void testPutIfAbsentAndUpdate() throws UnsupportedEncodingException {
        ...
        TrackedTorrent torrent =
                new TrackedTorrent(new byte[] {1, 2, 3}) {
                    @Override
                    public TrackedPeer update(
                        ...
                        return super.update(
                                event, peerId, hexPeerId, ip, port, uploaded, downloaded, left);
                    }
                };
    ...
    public void testThatCleanupDontLockAllTorrentsAndStorage() throws UnsupportedEncodingException {
        ...
        try {
            final Future<Integer> cleanupFuture =
    ...
    public void testThatTorrentsCanRemovedFromStorage() throws UnsupportedEncodingException {
        ...
        final TrackedPeer peer =
                new TrackedPeer(torrent, "127.0.0.1", 6881, ByteBuffer.allocate(5), timeService);
        torrent.addPeer(peer);

        timeService.setTime(15000);
        final TrackedPeer secondPeer =
                new TrackedPeer(torrent, "127.0.0.1", 6882, ByteBuffer.allocate(5), timeService);
