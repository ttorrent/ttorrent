...
public class ConnectionManager {
    ...
    public ConnectionManager(
            ...
            AtomicInteger myReceiveBufferSize)
            throws IOException {
    ...
    public void initAndRunWorker(ServerChannelRegister serverChannelRegister) throws IOException {
        ...
        myServerSocketChannel.register(
                selector, SelectionKey.OP_ACCEPT, new AcceptAttachmentImpl(myContext));
        ...
        myConnectionWorker =
                new ConnectionWorker(
                        ...
                        Arrays.asList(
                                ...
                                new AcceptableKeyProcessor(
                                        selector,
                                        serverName,
                                        myTimeService,
                                        myIncomingConnectionAllower,
                                        socketTimeoutStorage,
                                        mySendBufferSize,
                                        myReceiveBufferSize),
                                new ConnectableKeyProcessor(
                                        selector,
                                        myTimeService,
                                        socketTimeoutStorage,
                                        mySendBufferSize,
                        ...
                        DEFAULT_SELECTOR_SELECT_TIMEOUT_MILLIS,
                        DEFAULT_CLEANUP_RUN_TIMEOUT_MILLIS,
                        myTimeService,
        ...
        if (myConnectionWorker != null) {
            ...
            try {
                ...
                LoggerUtils.warnAndDebugDetails(
                        logger, "unable to await termination worker, thread was interrupted", e);
            }
        }
        try {
