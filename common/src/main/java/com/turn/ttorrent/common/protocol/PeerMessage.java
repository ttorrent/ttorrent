 ...
 *
 * <p>This class and its <em>*Messages</em> subclasses provide POJO representations of the peer
...
public abstract class PeerMessage {
     ...
     * Message type.
     *
     * <p>Note that the keep-alive messages don't actually have an type ID defined in the protocol
     * as they are of length 0.
     */
    public enum Type {
        KEEP_ALIVE(-1),
        CHOKE(0),
     ...
     *
     * <p>This method returns a duplicate of the buffer stored in this {@link PeerMessage} object to
     * allow for multiple consumers to read from the same message without conflicting access to the
     * buffer's position, mark and limit.
     */
     ...
     *
     * <p>This method is meant to be overloaded by distinct message types, where it makes sense.
     ...
     *
     * <p>Parses the provided byte array and builds the corresponding PeerMessage subclass object.
     *
        ...
        switch (type) {
            ...
            default:
                throw new IllegalStateException(
                        "Message type should have " + "been properly defined by now.");
        }
    }
    ...
    public static class KeepAliveMessage extends PeerMessage {
        ...
        public static KeepAliveMessage parse(ByteBuffer buffer, TorrentInfo torrent)
        ...
        public static KeepAliveMessage craft() {
            ByteBuffer buffer =
                    ByteBuffer.allocate(MESSAGE_LENGTH_FIELD_SIZE + KeepAliveMessage.BASE_SIZE);
    ...
    public static class ChokeMessage extends PeerMessage {
        ...
        public static ChokeMessage parse(ByteBuffer buffer, TorrentInfo torrent)
                throws MessageValidationException {
        ...
        public static ChokeMessage craft() {
            ByteBuffer buffer =
                    ByteBuffer.allocate(MESSAGE_LENGTH_FIELD_SIZE + ChokeMessage.BASE_SIZE);
    ...
    public static class UnchokeMessage extends PeerMessage {
        ...
        public static UnchokeMessage parse(ByteBuffer buffer, TorrentInfo torrent)
                throws MessageValidationException {
        ...
        public static UnchokeMessage craft() {
            ByteBuffer buffer =
                    ByteBuffer.allocate(MESSAGE_LENGTH_FIELD_SIZE + UnchokeMessage.BASE_SIZE);
    ...
    public static class InterestedMessage extends PeerMessage {
        ...
        public static InterestedMessage parse(ByteBuffer buffer, TorrentInfo torrent)
                throws MessageValidationException {
        ...
        public static InterestedMessage craft() {
            ByteBuffer buffer =
                    ByteBuffer.allocate(MESSAGE_LENGTH_FIELD_SIZE + InterestedMessage.BASE_SIZE);
    ...
    public static class NotInterestedMessage extends PeerMessage {
        ...
        public static NotInterestedMessage parse(ByteBuffer buffer, TorrentInfo torrent)
                throws MessageValidationException {
        ...
        public static NotInterestedMessage craft() {
            ByteBuffer buffer =
                    ByteBuffer.allocate(MESSAGE_LENGTH_FIELD_SIZE + NotInterestedMessage.BASE_SIZE);
     ...
     * Have message.
     *
     * <p><len=0005><id=4><piece index=xxxx>
     */
    public static class HaveMessage extends PeerMessage {
        ...
        public static HaveMessage parse(ByteBuffer buffer, TorrentInfo torrent)
                throws MessageValidationException {
        ...
        public static HaveMessage craft(int piece) {
            ByteBuffer buffer =
                    ByteBuffer.allocate(MESSAGE_LENGTH_FIELD_SIZE + HaveMessage.BASE_SIZE);
    ...
    public static class BitfieldMessage extends PeerMessage {
        ...
        public static BitfieldMessage parse(ByteBuffer buffer, TorrentInfo torrent)
                throws MessageValidationException {
     ...
     * Request message.
     *
     * <p><len=00013><id=6><piece index><block offset><block length>
     */
    public static class RequestMessage extends PeerMessage {
        ...
        public RequestMessage validate(TorrentInfo torrent) throws MessageValidationException {
            if (this.piece >= 0
                    ...
                    && this.offset + this.length <= torrent.getPieceSize(this.piece)) {
                return this;
            }
        ...
        public static RequestMessage parse(ByteBuffer buffer, TorrentInfo torrent)
                throws MessageValidationException {
        ...
        public static RequestMessage craft(int piece, int offset, int length) {
            ByteBuffer buffer =
                    ByteBuffer.allocate(MESSAGE_LENGTH_FIELD_SIZE + RequestMessage.BASE_SIZE);
     ...
     * Piece message.
     *
     * <p><len=0009+X><id=7><piece index><block offset><block data>
     */
    public static class PieceMessage extends PeerMessage {
        ...
        public PieceMessage validate(TorrentInfo torrent) throws MessageValidationException {
            if (this.piece >= 0
                    && this.piece < torrent.getPieceCount()
                    && this.offset + this.block.limit() <= torrent.getPieceSize(this.piece)) {
                return this;
            }
        ...
        public static PieceMessage parse(ByteBuffer buffer, TorrentInfo torrent)
                throws MessageValidationException {
            int piece = buffer.getInt();
            int offset = buffer.getInt();
        ...
        public static ByteBuffer createBufferWithHeaderForMessage(
                int piece, int offset, int blockSize) {
            ByteBuffer result =
                    ByteBuffer.allocate(
     ...
     * Cancel message.
     *
     * <p><len=00013><id=8><piece index><block offset><block length>
     */
    public static class CancelMessage extends PeerMessage {
        ...
        public static CancelMessage parse(ByteBuffer buffer, TorrentInfo torrent)
                throws MessageValidationException {
            int piece = buffer.getInt();
            int offset = buffer.getInt();
            int length = buffer.getInt();
        ...
        public static CancelMessage craft(int piece, int offset, int length) {
            ByteBuffer buffer =
                    ByteBuffer.allocate(MESSAGE_LENGTH_FIELD_SIZE + CancelMessage.BASE_SIZE);
