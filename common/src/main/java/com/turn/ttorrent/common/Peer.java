 ...
 *
 * <p>This class is meant to be a common base for the tracker and client, which would presumably
...
public class Peer {
    ...
    public String getShortHexPeerId() {
        return String.format(
                "..%s", this.hexPeerId.substring(this.hexPeerId.length() - 6).toUpperCase());
    }
    ...
    public boolean equals(Object o) {
        ...
        if (hexPeerId != null ? !hexPeerId.equals(peer.hexPeerId) : peer.hexPeerId != null)
            return false;
        return hexInfoHash != null
                ? hexInfoHash.equals(peer.hexInfoHash)
                : peer.hexInfoHash == null;
    }
