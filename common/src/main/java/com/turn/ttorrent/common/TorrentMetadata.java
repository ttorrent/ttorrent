 ...
 *
 * @see <a
 *     href="https://wiki.theory.org/index.php/BitTorrentSpecification#Metainfo_File_Structure"></a>
 */
public interface TorrentMetadata extends TorrentHash {
    ...
    /**
     * @return concatenation of all 20-byte SHA1 hash values, one per piece. So the length of this
     *     array must be a multiple of 20
     */
    byte[] getPiecesHashes();

    /**
     * @return true if it's private torrent. In this case client must get peers only from tracker
     *     and must initiate connections to peers returned from the tracker.
