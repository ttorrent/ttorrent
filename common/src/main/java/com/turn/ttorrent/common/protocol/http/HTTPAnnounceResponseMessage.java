...
public class HTTPAnnounceResponseMessage extends HTTPTrackerMessage
    ...
    private HTTPAnnounceResponseMessage(
            ByteBuffer data, int interval, int complete, int incomplete, List<Peer> peers) {
        ...
        try {
            ...
            if (params.get("torrentIdentifier") != null) {
                return new HTTPAnnounceResponseMessage(
                        ...
                        peers,
                        params.get("torrentIdentifier").getString());
            } else {
                return new HTTPAnnounceResponseMessage(
                        Constants.EMPTY_BUFFER,
                        params.get("interval").getInt(),
     ...
     */
    private static List<Peer> toPeerList(List<BEValue> peers) throws InvalidBEncodingException {
     ...
     * @param peers
     */
    public static HTTPAnnounceResponseMessage craft(
        ...
        return new HTTPAnnounceResponseMessage(
                BEncoder.bencode(response), interval, complete, incomplete, peers, hexInfoHash);
    }
}
