...
public class TorrentUtilsTest {
    ...
    public void testBytesToHexWithSingleByte() {
        assertEquals("BC", TorrentUtils.byteArrayToHexString(new byte[] {(byte) 0xBC}));
    }
    ...
    public void testBytesToHexWithLeadingZero() {
        assertEquals(
                "0053FF",
                TorrentUtils.byteArrayToHexString(
                        new byte[] {(byte) 0x00, (byte) 0x53, (byte) 0xFF}));
    }
    ...
    public void testBytesToHexTrailingZero() {
        assertEquals(
                "AA004500",
                TorrentUtils.byteArrayToHexString(
                        new byte[] {(byte) 0xAA, (byte) 0x00, (byte) 0x45, (byte) 0x00}));
    }
