...
public class MetadataBuilderTest {
    ...
    public void testMultiFileModeWithOneFile() throws IOException {
        Map<String, BEValue> map =
                new MetadataBuilder()
                        .setDirectoryName("root")
                        .addDataSource(
                                new ByteArrayInputStream(new byte[] {1, 2}), "path/some_file", true)
                        .buildBEP()
                        .getMap();
    ...
    public void testBuildWithSpecifiedHashes() throws IOException {
        ...
        Map<String, BEValue> metadata =
                new MetadataBuilder()
                        .setPiecesHashesCalculator(
                                new PiecesHashesCalculator() {
                                    @Override
                                    public HashingResult calculateHashes(
                                            List<DataSourceHolder> sources, int pieceSize) {
